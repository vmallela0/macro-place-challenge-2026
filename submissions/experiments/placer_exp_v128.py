"""exp_v128 (idea IP6): regular grid init, largest macros first."""
import sys, torch
...
from _init_variants import grid_init


class OptimalPlacer(_m.OptimalPlacer):
    def place(self, benchmark):
        n_hard = benchmark.num_hard_macros
        alt = grid_init(benchmark.macro_positions[:n_hard].numpy().astype('float64'), benchmark)
