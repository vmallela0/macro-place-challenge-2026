"""exp_v43: v36 with MUCH smaller start cycle (fast initial exploration)."""
import sys
import time
import random
...
class OptimalPlacer:
    def __init__(self, seed=42):
        ...
        self.START_CYCLE_T = 15  # small start, grow aggressively
    ...
    def place(self, benchmark: Benchmark) -> torch.Tensor:
        ...
        while time.time() - t0 < self.TOTAL_BUDGET - 5:
            ...
            if gain < 1e-4:
                ...
                cycle_t = min(50, cycle_t * 1.3)  # grow faster
            last_cost = best_cost
