"""exp_v45: v36 + per-net optimization phase before soft cycles."""
import sys
import time
import random
...
class OptimalPlacer:
    ...
    def place(self, benchmark: Benchmark) -> torch.Tensor:
        ...
        # Per-net optimization (NEW)
        try:
            _, c = per_net_optimize(best_pos, benchmark, incr_eval, max_time=20, verbose=True)
            if c < best_cost: best_cost = c
        except Exception as e:
            print(f"    per_net error: {e}")
