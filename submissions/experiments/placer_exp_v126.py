"""exp_v126 (idea IP1): random init replacing benchmark .plc initial.

Null-hypothesis test: does the benchmark's initial actually help?
"""
import sys, torch
...
from _init_variants import random_init


class OptimalPlacer(_m.OptimalPlacer):
    def place(self, benchmark):
        n_hard = benchmark.num_hard_macros
        alt = random_init(benchmark.macro_positions[:n_hard].numpy().astype('float64'),
