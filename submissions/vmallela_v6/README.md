...
Sweep run on 2026-04-28 17:58 UTC, `PLACER_TOTAL_BUDGET=1800` s per worker, `PLACER_V6_WORKERS=8` (1 GPU + 7 CPU), consensus refine 120 s, base seed 42. Hardware: Apple M5 Pro (18 cores, 20-core GPU, 48 GB unified). Backend: torch.MPS.
...
| ibm16 | 1.0955 | 0 | 2102 | 1.0771 | -0.0184 |
| ibm17 | 1.3027 | 0 | 2207 | 1.3012 | -0.0015 |
| ibm18 | 1.2846 | 0 | 2004 | 1.2865 | +0.0019 |
| **mean (all)** | **1.0196** | — | — | **1.0186** | **-0.0010** |
